...
#### [BettingAIPro](https://betting-ai-pro.vercel.app) &nbsp;<sub>· _live_</sub>

An AI sports prediction app — a two-model pipeline that turns live football data into probability-graded bets with Kelly-sized stakes.
...
**Stack** &nbsp;·&nbsp; Next.js 16 · React 19 · TypeScript · Tailwind 4 &nbsp;·&nbsp; FastAPI · PostgreSQL (Supabase) &nbsp;·&nbsp; Groq (Qwen3 32B) · Gemini 3.1 Pro
